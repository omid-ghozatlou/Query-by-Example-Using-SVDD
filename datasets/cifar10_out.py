...
class CIFAR10_out(TorchvisionDataset):
    ...
    def __init__(self, root: str, normal_class=5):
        ...
        train_idx_out = get_target_label_idx(train_set.targets, self.outlier_classes)
        train_out = np.random.choice(train_idx_out, int((0.1) * len(train_idx_normal)))
