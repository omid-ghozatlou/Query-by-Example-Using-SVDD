...
class CIFAR10_LeNet_MS(BaseNet):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(13, 32, 5, bias=False, padding=2)
...
class CIFAR10_LeNet_MS_Autoencoder(BaseNet):
    ...
    def __init__(self):
        ...
        self.deconv4 = nn.ConvTranspose2d(32, 13, 5, bias=False, padding=2)
...
#         self.conv1 = nn.Conv2d(3*217, 32, 5, bias=False, padding=2) # 3*81 for scattering
#         self.bn2d1 = nn.BatchNorm2d(32, eps=1e-04, affine=False)
#         self.conv2 = nn.Conv2d(32, 64, 5, bias=False, padding=2)
#         self.bn2d2 = nn.BatchNorm2d(64, eps=1e-04, affine=False)
#         self.conv3 = nn.Conv2d(64, 128, 5, bias=False, padding=2)
...
#         nn.init.xavier_uniform_(self.deconv3.weight, gain=nn.init.calculate_gain('leaky_relu'))
#         self.bn2d6 = nn.BatchNorm2d(32, eps=1e-04, affine=False)
#         self.deconv4 = nn.ConvTranspose2d(32, 3*217, 5, bias=False, padding=2)# 3*81 for scattering
#         nn.init.xavier_uniform_(self.deconv4.weight, gain=nn.init.calculate_gain('leaky_relu'))
